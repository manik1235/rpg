   ...
   Begin VB.Frame ToolWindow 
      ...
      Begin VB.Frame frameTool 
         ...
         Begin VB.ListBox listTiles 
            Height          =   3375
            ItemData        =   "MapEditor.frx":030A
            Left            =   720
            List            =   "MapEditor.frx":030C
            TabIndex        =   17
            Top             =   240
            Width           =   2775
         End
...
On Error GoTo errh
  ...
  If RightClick = False And Button = 0 And Shift = 0 And Left(Tile.XY(pX(X) - 1, pY(Y) - 1).SpecialTile, 7) = "Monster" And Not SetBounds Then
