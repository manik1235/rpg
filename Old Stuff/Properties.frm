...
Begin VB.Form Properties 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Map"
      TabPicture(0)   =   "Properties.frx":0000
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "MapDesc"
      Tab(0).Control(1)=   "MapName"
      Tab(0).Control(2)=   "lblNumMonsters"
      Tab(0).Control(3)=   "lblNumPlayers"
      Tab(0).Control(4)=   "lblMapSize"
      ...
      TabCaption(1)   =   "Player"
      TabPicture(1)   =   "Properties.frx":001C
      ...
      TabPicture(2)   =   "Properties.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Frame3"
      Tab(2).Control(1)=   "Frame4"
      Tab(2).ControlCount=   2
      TabCaption(3)   =   "Events"
      TabPicture(3)   =   "Properties.frx":0054
